...
import com.example.tallerarquitectura.view.navigation.EnterpriseCreateRoute
import com.example.tallerarquitectura.view.navigation.EnterpriseEditRoute
import kotlinx.coroutines.launch

@OptIn(ExperimentalMaterial3Api::class, ExperimentalFoundationApi::class)
@Composable
fun EnterpriseScreen(
    enterprises: List<Enterprise> = emptyList<Enterprise>(),
    ...
    val selectedItem = remember {
        mutableStateOf<Enterprise?>(null)
    }
                ...
                Box(
                    ...
                    selectedItem.value?.let {
                        Row() {
                            IconButton(
                                onClick = {
                                    MainActivity.navManager.navigateTo(EnterpriseEditRoute(it.id))
                                }) {
                    ...
                    FloatingActionButton(
                        onClick = {
                            MainActivity.navManager.navigateTo(EnterpriseCreateRoute)
                        },
                        modifier = Modifier
                            .padding(end = 16.dp)
...
private fun EnterpriseScreenPreview() {
            val data=emptyList<Enterprise>()
