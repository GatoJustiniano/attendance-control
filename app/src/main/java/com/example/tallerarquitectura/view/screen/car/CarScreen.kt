...
import com.example.tallerarquitectura.view.navigation.CarCreateRoute
import com.example.tallerarquitectura.view.navigation.CarEditRoute
...
@Composable
fun CarScreen(
    enterprises: List<Car> = emptyList<Car>(),
                ...
                Box(
                    ...
                    selectedItem.value?.let {
                        Row() {
                            IconButton(
                                onClick = {
                                    MainActivity.navManager.navigateTo(CarEditRoute(it.id))
                                }) {
                    ...
                    FloatingActionButton(
                        onClick = {
                            MainActivity.navManager.navigateTo(CarCreateRoute)
                        },
                        modifier = Modifier
                            .padding(end = 16.dp)
                    ...
                    Box(
                        ...
                        Row (
                            ...
                            Column(
                                ...
                                Text(it.plate, style = MaterialTheme.typography.titleSmall)
                                Text("${it.alias?:"Sin alias"} • ${it.mark} • ${it.model} • ${it.year}", style = MaterialTheme.typography.bodyMedium)
                            }
                        }
