...
import com.example.tallerarquitectura.view.navigation.HorarioCreateRoute
import com.example.tallerarquitectura.view.navigation.HorarioEditRoute
...
@Composable
fun HorarioScreen(
    grupos: List<Horario> = emptyList<Horario>(),
                ...
                Box(
                    ...
                    selectedItem.value?.let {
                        Row() {
                            IconButton(
                                onClick = {
                                    MainActivity.navManager.navigateTo(HorarioEditRoute(it.id))
                                }) {
                    ...
                    FloatingActionButton(
                        onClick = {
                            MainActivity.navManager.navigateTo(HorarioCreateRoute)
                        },
                        modifier = Modifier
                            .padding(end = 16.dp)
