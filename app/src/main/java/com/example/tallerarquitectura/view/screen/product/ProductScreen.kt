...
import com.example.tallerarquitectura.view.navigation.ProductCreateRoute
import com.example.tallerarquitectura.view.navigation.ProductEditRoute
...
@Composable
fun ProductScreen(
    enterprises: List<Product> = emptyList<Product>(),
                ...
                Box(
                    ...
                    selectedItem.value?.let {
                        Row() {
                            IconButton(
                                onClick = {
                                    MainActivity.navManager.navigateTo(ProductEditRoute(it.id))
                                }) {
                    ...
                    FloatingActionButton(
                        onClick = {
                            MainActivity.navManager.navigateTo(ProductCreateRoute)
                        },
                        modifier = Modifier
                            .padding(end = 16.dp)
