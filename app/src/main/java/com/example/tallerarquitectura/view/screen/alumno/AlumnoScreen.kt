package com.example.tallerarquitectura.view.screen.alumno
...
import com.example.tallerarquitectura.view.navigation.AlumnoCreateRoute
import com.example.tallerarquitectura.view.navigation.AlumnoEditRoute
...
@Composable
fun AlumnoScreen(
    grupos: List<Alumno> = emptyList<Alumno>(),
    listener: ActionListener<Alumno>,
                ...
                Box(
                    ...
                    selectedItem.value?.let {
                        Row() {
                            IconButton(
                                onClick = {
                                    MainActivity.navManager.navigateTo(AlumnoEditRoute(it.id))
                                }) {
                    ...
                    FloatingActionButton(
                        onClick = {
                            MainActivity.navManager.navigateTo(AlumnoCreateRoute)
                        },
                        modifier = Modifier
                            .padding(end = 16.dp)
