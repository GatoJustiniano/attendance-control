...
@Composable
fun MateriaEditScreen(
    materia: Materia,
    listener: ActionListener<Materia>,
    uiProvider: UiProvider
) {
    val name= remember { mutableStateOf(materia.name) }
    ...
    Scaffold(
                ...
                actions = {
                    ...
                    TextButton(onClick = {
                        ...
                        if(errorsForm.any()){
                            ...
                            listener.update(Materia(materia.id, name.value))
        ...
        Column(modifier = Modifier
            ...
            Text("Formulario de actualización",
...
@Composable
@Preview
private fun MateriaEditScreenEditScreenPreview(){
    val context=LocalContext.current
    val navHostController=rememberNavController()
    val uiAppViewModel= UiAppViewModel()
    val uiProvider= UiProvider(uiAppViewModel)
    MateriaEditScreen(
        materia = Materia(1,"Materia 1"),
        listener = ControllerProvider().materiaController,
        uiProvider = uiProvider
    )
}
