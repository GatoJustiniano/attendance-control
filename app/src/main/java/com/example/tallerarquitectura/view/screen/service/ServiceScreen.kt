...
import com.example.tallerarquitectura.view.navigation.ServiceCreateRoute
import com.example.tallerarquitectura.view.navigation.ServiceEditRoute
import kotlinx.coroutines.launch

@OptIn(ExperimentalMaterial3Api::class, ExperimentalFoundationApi::class)
@Composable
fun ServiceScreen(
    services: List<Service> = emptyList<Service>(),
                ...
                Box(
                    ...
                    selectedItem.value?.let {
                        Row() {
                            IconButton(
                                onClick = {
                                    MainActivity.navManager.navigateTo(ServiceEditRoute(it.id))
                                }) {
                    ...
                    FloatingActionButton(
                        onClick = {
                            MainActivity.navManager.navigateTo(ServiceCreateRoute)
                        },
                        modifier = Modifier
                            .padding(end = 16.dp)
...
private fun ServiceScreenPreview() {
    ...
    ServiceScreen(
        data,
        ControllerProvider().serviceController,
        uiProvider = uiProvider
    )
}