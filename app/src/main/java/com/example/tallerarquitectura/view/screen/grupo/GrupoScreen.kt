...
import com.example.tallerarquitectura.view.navigation.GrupoCreateRoute
import com.example.tallerarquitectura.view.navigation.GrupoEditRoute
import kotlinx.coroutines.launch

@OptIn(ExperimentalMaterial3Api::class, ExperimentalFoundationApi::class)
@Composable
fun GrupoScreen(
    grupos: List<Grupo> = emptyList<Grupo>(),
                ...
                Box(
                    ...
                    selectedItem.value?.let {
                        Row() {
                            IconButton(
                                onClick = {
                                    MainActivity.navManager.navigateTo(GrupoEditRoute(it.id))
                                }) {
                    ...
                    FloatingActionButton(
                        onClick = {
                            MainActivity.navManager.navigateTo(GrupoCreateRoute)
                        },
                        modifier = Modifier
                            .padding(end = 16.dp)
...
private fun EnterpriseScreenPreview() {
    ...
    GrupoScreen(
        data,
        ControllerProvider().grupoController,
        uiProvider = uiProvider
    )
}