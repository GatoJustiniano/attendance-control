...
import com.example.tallerarquitectura.validation.alumnoFormValidate
...
@Composable
fun AlumnoEditScreen(
    alumno: Alumno,
    listener: ActionListener<Alumno>,
    uiProvider: UiProvider,
) {
    val name = remember { mutableStateOf(alumno.name) }
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    ...
                    TextButton(onClick = {
                        val errorsForm = alumnoFormValidate(name.value)
                        if (errorsForm.any()) {
